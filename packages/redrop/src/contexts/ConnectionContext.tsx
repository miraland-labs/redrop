...
import {
  ...
  TokenListProvider,
  ENV as ChainId,
} from '@solarti/spl-token-registry';
...
export type ENDPOINT_NAME = 'mainnet-mln' | 'testnet-mln' | 'devnet-mln' | 'localnet-mln';
...
export const ENDPOINTS: Array<Endpoint> = [
  {
    ...
    url: 'https://api.mainnet-mln.miraland.top',
    chainId: ChainId.Mainnet,
  },
  {
    name: 'devnet-mln',
    // url: 'https://metaplex.devnet.rpcpool.com/',
    url: 'https://api.devnet-mln.arcaps.com',
...
const ConnectionContext = React.createContext<ConnectionConfig>({
  connection: new Connection(DEFAULT_ENDPOINT.url, 'processed'),
...
export const explorerLinkCForAddress = (
  ...
  return (
    <a
      href={`https://explorer.miraland.top/address/${key}?cluster=${envFor(
        connection,
      )}`}
      target="_blank"
      rel="noreferrer"
