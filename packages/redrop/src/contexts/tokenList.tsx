...
import { useConnectionConfig } from './ConnectionContext';
import { TokenInfo, TokenListContainer } from '@solarti/spl-token-registry';
...
export function SPLTokenListProvider({
  ...
  // Added tokenList to know in which currency the auction is (MLN or other SPL)
