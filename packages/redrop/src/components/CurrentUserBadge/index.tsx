...
import { PublicKey, LAMPORTS_PER_MLN } from '@solarti/web3.js';
...
export const CurrentUserBadge = (props: {
  ...
  const balance = (account?.lamports || 0) / LAMPORTS_PER_MLN;
  ...
  return (
    <div className="wallet-wrapper">
      {props.showBalance && (
        <span>
          {formatNumber.format((account?.lamports || 0) / LAMPORTS_PER_MLN)} MLN
        </span>
      )}
            ...
            additionalSettings={
              ...
              >
                ...
                >
                  ...
                  >
                    {formatNumber.format(balance)} MLN
                  </span>
                  &nbsp;
                  <span
                    style={{
