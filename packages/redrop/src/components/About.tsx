...
export const About = () => {
  const summary = (
    <Stack spacing={1}>
      <div>
        The Redrop program leverages the Miraland blockchain and merkle trees to
      ...
      <div>
        ...
        achieve such a setup and Redrop offers one that integrates with
        existing Miraland, Solarti and Miraplex ecosystem programs.
      </div>

      <div>
        Redrop solves this efficient-airdrop issue by utilizing a
      ...
      <div>
        ...
        , and now is extended by Miraplex to allow pre-minting a Candy Machine
        or printing editions of a master copy. Moreover, Redrop allows creators
        to directly send whitelisted users a drop reclamation link by building
  ...
  const create = (
    <Stack spacing={1}>
      ...
      <div>
        ...
        <a
          href="https://docs.miraland.top/airdrops/create-redrop"
          target="_blank"
          rel="noreferrer"
        >
          Miraplex Docs
  ...
  const close = (
    <Stack spacing={1}>
      ...
      <div>
        Closing the Redrop cleans up the on-chain state and allows creators to
